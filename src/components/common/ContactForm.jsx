    ...
    <section id="contact" className="py-14">
      <div className="wrapper grid md:grid-cols-[55%,1fr] gap-8 md:gap-6">
        <div className="space-y-4">
          ...
          <h2 className="text1">Tell Us About Your Next Release</h2>
          <p className="desc text-white/70">
            Share goals around website performance, mobile conversion,
            automation, or analytics—we will respond with a tailored approach,
            timeline range, and the specialists you would work with. Expect
            clarity, not jargon.
          </p>
