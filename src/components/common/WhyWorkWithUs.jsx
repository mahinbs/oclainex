    ...
    <div className="py-14">
      <div className="wrapper flex flex-col items-center gap-3">
        ...
        <h2 className="text1 text-center max-w-3xl mx-auto">
          A Partner for Product, Engineering & Security
        </h2>
        <p className="desc text-center max-w-3xl mx-auto">
          Engage Oclainex when you need accountable delivery across design,
          engineering, cloud, and analytics—with the documentation and runbooks
          modern compliance teams expect.
        </p>
      </div>
