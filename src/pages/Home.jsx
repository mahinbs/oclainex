...
const HowWeBuildYourProduct = lazy(() =>
  import("../components/common/HowWeBuildYourProduct")
);
        ...
        <div className="wrapper absolute w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[2] flex flex-col-reverse gap-5 sm:grid grid-cols-[1fr,20%] items-center">
          <div data-aos="fade-up" className="max-w-[50rem] space-y-1">
            ...
            <h1 className="text_xl">
              Software Development & Digital  Solutions Partner for{" "}
              
              <span className="text-primary">AI, Cloud & Mobile</span>
            </h1>
      ...
      <section className="wrapper">
        ...
        >
          <img
            loading="lazy"
            src={heroImg}
            className="h-full w-full object-cover scale-[101%] brightness-50"
            alt="Oclainex technology team delivering AI, web, and mobile solutions"
            data-aos="fade-right"
          />
          <div className="2xl:absolute left-1/2 -translate-x-1/2 top-1/2 2xl:-translate-y-1/2 p-5 2xl:px-10 2xl:w-full">
            <p
              data-aos="fade-left"
              className="text-lg md:text-2xl !font-normal text-white/70"
            >
              <b className="text-white">Oclainex</b> helps organizations ship{" "}
              <b className="text-white">secure, scalable software</b> across{" "}
              <b className="text-white">website development</b>,{" "}
              <b className="text-white">mobile app development</b>,{" "}
              <b className="text-white">AI</b>, <b className="text-white">cloud</b>
              , and <b className="text-white">data analytics</b>—with engineering
              rigour from discovery to launch.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-[40%,1fr] gap-10">
          ...
          <div data-aos="fade-up" className="space-y-3">
            ...
            <p className="desc text-white/70">
              At Oclainex, we partner with teams that need velocity without
              sacrificing reliability—whether that means{" "}
              <b className="text-white">custom software development</b>,{" "}
              <b className="text-white">UX/UI design</b>,{" "}
              <b className="text-white">enterprise integrations</b>, or{" "}
              <b className="text-white">cybersecurity‑aware delivery</b>. We align
              architecture, product UX, and analytics so every release is
              measurable, maintainable, and ready to scale with your roadmap.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex gap-2">
                ...
                <p className="desc">
                  Cloud‑ready architecture, observability, and guardrails for
                  growth
                </p>
              </div>
              <div className="flex gap-2">
                <div className="w-4 h-4 min-w-4 bg-secondary rounded-full mt-[.30rem]" />
                <p className="desc">
                  Analytics and AI that leaders can explain and trust
                </p>
              </div>
            </div>
          </div>
