        ...
        <div className="wrapper absolute w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[2] flex flex-col-reverse gap-5 sm:grid grid-cols-[1fr,20%] items-center">
          <div data-aos="fade-up" className="max-w-[45rem] space-y-1">
            ...
            <h1 className="text_xl">
              {isWeb ? "Enterprise " : "Native & "}
              <span className="text-primary">
                {isWeb
                  ? "Web Development & SEO-Ready Sites"
            ...
            <p className="desc">
              {isWeb
                ? "Speed, technical SEO, responsive UX, and API‑connected web applications engineered for conversions and long‑term maintainability."
                : "High‑performance iOS and Android apps—offline‑ready UX, push, payments, analytics, and store‑compliant releases."}
            </p>
      ...
      <section className="wrapper">
        ...
        >
          ...
          <div className="2xl:absolute right-0 top-1/2 2xl:-translate-y-1/2 p-5 2xl:px-10 2xl:w-2/5">
            ...
            >
              <b className="text-white">Oclainex</b> combines product design,
              secure engineering, and DevOps discipline for{" "}
              {isWeb
                ? "content‑rich marketing sites, portals, and React/Next‑style web apps with Core Web Vitals in mind."
                : "Flutter, React Native, or native stacks that feel fast on real devices and real networks."}{" "}
              Ask us how {isWeb ? "search-first" : "retention-first"} delivery
              maps to your KPIs.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-[40%,1fr] gap-7">
          ...
          <div data-aos="fade-up" className="space-y-3">
            ...
            <p className="desc text-white/70">
              Oclainex operates as an extension of your product team.{" "}
              {isWeb
                ? "We modernize legacy front ends, implement design systems, integrate CRMs and payment gateways, and instrument analytics so marketing and engineering share one truth."
                : "We map app store requirements early, bake in crash reporting and feature flags, and ship builds your QA and stakeholders can trace end-to-end."}{" "}
              Every engagement prioritizes uptime, security review checkpoints, and
              documentation your internal teams can run with.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex gap-2">
                ...
                <p className="desc">
                  Production-grade {isWeb ? "hosting & CDN" : "release"}{" "}
                  patterns that survive traffic spikes
                </p>
              </div>
              <div className="flex gap-2">
                <div className="w-4 h-4 min-w-4 bg-secondary rounded-full mt-[.30rem]" />
                <p className="desc">
                  Dashboards, experiments, and ML hooks when you are ready
                </p>
              </div>
            </div>
          </div>
