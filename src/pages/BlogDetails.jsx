...
const BlogDetails = () => {
  ...
  return (
    <div className="mt-[5.5rem] lg:mt-[9rem] min-h-screen text-white max-w-[100vw]">
      {/* Meta Tags */}
      <Helmet>
        <title>{blog.title} | Oclainex</title>
        ...
        <div className="">
          ...
          <div className="mt-16 p-8 bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl border border-gray-700 text-center">
            <h3 className="text2 font-bold mb-4">
              Plan Your Next AI, Web, or Mobile Initiative
            </h3>
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Book a strategy call with Oclainex to translate roadmap goals into
              an actionable backlog, architecture sketch, and success metrics.
            </p>
            <Link
              to="/contact-us"
